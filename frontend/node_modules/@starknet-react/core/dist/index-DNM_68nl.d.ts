...
import { ProviderOptions, ProviderInterface, AccountInterface, BlockNumber, GetBlockResponse, Result as Result$1, Abi, Contract, ArgsOrCalldata, CallOptions, Call, CompiledContract, ContractFactory, RawArgs, BigNumberish, InvocationsDetails, DeployContractResponse, EstimateFeeDetails, EstimateFeeResponse, Nonce, GetTransactionReceiptResponse, BlockIdentifier as BlockIdentifier$1 } from 'starknet';
import { RpcMessage, RequestFnCall, RpcTypeToMessageMap, StarknetWindowObject, AddStarknetChainParameters, AddDeclareTransactionParameters, TypedData, SwitchStarknetChainParameters, WatchAssetParameters, Events } from '@starknet-io/types-js';
import EventEmitter from 'eventemitter3';
import { QueryKey, UseQueryOptions, UseQueryResult as UseQueryResult$1, UseMutationOptions, UseInfiniteQueryOptions, UseInfiniteQueryResult as UseInfiniteQueryResult$1, InfiniteData, UseMutationResult as UseMutationResult$1 } from '@tanstack/react-query';
...
type UseBalanceProps = UseQueryProps<Balance, Error, Balance, ReturnType<typeof queryKey$a>> & {
...
declare function queryKey$a({ chain, token, address, blockIdentifier, }: {
    chain: Chain;
    token?: string;
    address?: string;
    blockIdentifier?: BlockNumber;
...
type UseBlockProps = UseQueryProps<GetBlockResponse, Error, GetBlockResponse, ReturnType<typeof queryKey$9>> & {
...
declare function queryKey$9({ blockIdentifier }: {
    blockIdentifier: BlockNumber;
}): readonly [{
...
type UseBlockNumberProps = UseQueryProps<number | undefined, Error, number, ReturnType<typeof queryKey$8>> & {
    /** Identifier for the block to fetch. */
    blockIdentifier?: BlockNumber;
};
...
type CallQueryKey = typeof queryKey$7;
/** Options for `useCall`. */
...
declare function queryKey$7({ chain, contract, functionName, args, blockIdentifier, }: {
    chain?: Chain;
    contract?: Contract;
} & CallArgs): readonly [{
...
type UseEstimateFeesProps = EstimateFeesArgs & UseQueryProps<EstimateFeeResponse, Error, EstimateFeeResponse, ReturnType<typeof queryKey$6>> & {
    /** Refresh data at every block. */
    watch?: boolean;
};
...
declare function queryKey$6({ calls, options }: EstimateFeesArgs): readonly [{
...
type UseNonceForAddressProps = UseQueryProps<Nonce, Error, Nonce, ReturnType<typeof queryKey$5>> & {
...
declare function queryKey$5({ address, blockIdentifier, }: {
    address: Address;
    blockIdentifier: BlockNumber;
}): readonly [{
...
type StarkNameArgs = UseQueryProps<string, Error, string, ReturnType<typeof queryKey$3>> & {
    /** Account address. */
    address?: Address;
    /** Naming contract to use . */
    contract?: Address;
...
type StarkProfileArgs = UseQueryProps<GetStarkprofileResponse, Error, GetStarkprofileResponse, ReturnType<typeof queryKey$2>> & {
    /** Account address. */
    address?: Address;
...
declare function queryKey$2({ address, namingContract, identityContract, network, useDefaultPfp, }: {
    address?: string;
...
type UseTransactionReceiptProps = UseQueryProps<GetTransactionReceiptResponse, Error, GetTransactionReceiptResponse, ReturnType<typeof queryKey$1>> & {
...
type UseEventsProps = UseInfiniteQueryProps<EventsType, Error, EventsType, EventsType, ReturnType<typeof queryKey>, string> & {
...
declare function queryKey({ address, eventName, fromBlock, toBlock, pageSize, }: {
    address?: Address;
    eventName?: string;
    fromBlock?: BlockIdentifier;
    toBlock?: BlockIdentifier;
