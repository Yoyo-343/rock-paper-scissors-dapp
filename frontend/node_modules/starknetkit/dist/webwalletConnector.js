...
import { C as U, P as D, a as d, b as g, U as C, r as N } from "./connector-d812307b.js";
import { s as E, M as R, T as x, t as _, m as H, a as T, g as S, D as M } from "./trpc-94e013dd.js";
...
const q = 385, G = 775, j = 385, z = 440, $ = 420, F = 438, m = [], X = (a, n) => ({
  ...
  const n = a === v.NetworkName.SN_MAIN ? R : x;
  try {
  ...
  const e = H(a), { allowedDapps: o } = await Z(e);
...
class it extends U {
  ...
  async disconnect() {
    if (!this.available() && !this._wallet)
      throw new g();
    l = null, h = null, this._wallet = l, N();
  }
  async account(s) {
...
export {
  ...
  it as WebWalletConnector,
  B as WebwalletError,
  lt as handleWebwalletLogoutEvent
};
