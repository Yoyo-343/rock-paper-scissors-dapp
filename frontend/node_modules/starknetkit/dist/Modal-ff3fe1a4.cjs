...
`,Sr=()=>{const l="starknetkit-modal-container",e=document.getElementById(l);if(e){if(e.shadowRoot)return e.shadowRoot;e.remove()}const o=document.createElement("div");o.id=l,document.body.appendChild(o);const r=o.attachShadow({mode:"open"}),a=document.createElement("style");return a.textContent=Mr,r.appendChild(a),r};function B(){}function Ft(l,e){for(const o in e)l[o]=e[o];return l}function cr(l){return l()}function It(){return Object.create(null)}function ke(l){l.forEach(cr)}function me(l){return typeof l=="function"}function U(l,e){return l!=l?e==e:l!==e||l&&typeof l=="object"||typeof l=="function"}let yt;function $r(l,e){return l===e?!0:(yt||(yt=document.createElement("a")),yt.href=e,l===yt.href)}function Er(l){return Object.keys(l).length===0}function be(l,e,o,r){if(l){const a=fr(l,e,o,r);return l[0](a)}}function fr(l,e,o,r){return l[1]&&r?Ft(o.ctx.slice(),l[1](r(e))):o.ctx}function we(l,e,o,r){if(l[2]&&r){const a=l[2](r(o));if(e.dirty===void 0)return a;if(typeof a=="object"){const n=[],s=Math.max(e.dirty.length,a.length);for(let f=0;f<s;f+=1)n[f]=e.dirty[f]|a[f];return n}return e.dirty|a}return e.dirty}function Ce(l,e,o,r,a,n){if(a){const s=fr(e,o,r,n);l.p(s,a)}}function _e(l){if(l.ctx.length>32){const e=[],o=l.ctx.length/32;for(let r=0;r<o;r++)e[r]=-1;return e}return-1}function i(l,e){l.appendChild(e)}function Nr(l,e,o){const r=Zr(l);if(!r.getElementById(e)){const a=x("style");a.id=e,a.textContent=o,Ar(r,a)}}function Zr(l){if(!l)return document;const e=l.getRootNode?l.getRootNode():l.ownerDocument;return e&&e.host?e:l.ownerDocument}function Ar(l,e){return i(l.head||l,e),e.sheet}function $(l,e,o){l.insertBefore(e,o||null)}function M(l){l.parentNode&&l.parentNode.removeChild(l)}function zr(l,e){for(let o=0;o<l.length;o+=1)l[o]&&l[o].d(e)}function x(l){return document.createElement(l)}function c(l){return document.createElementNS("http://www.w3.org/2000/svg",l)}function Q(l){return document.createTextNode(l)}function K(){return Q(" ")}function ye(){return Q("")}function Ee(l,e,o,r){return l.addEventListener(e,o,r),()=>l.removeEventListener(e,o,r)}function t(l,e,o){o==null?l.removeAttribute(e):l.getAttribute(e)!==o&&l.setAttribute(e,o)}const Or=["width","height"];function Ur(l,e){const o=Object.getOwnPropertyDescriptors(l.__proto__);for(const r in e)e[r]==null?l.removeAttribute(r):r==="style"?l.style.cssText=e[r]:r==="__value"?l.value=l[r]=e[r]:o[r]&&o[r].set&&Or.indexOf(r)===-1?l[r]=e[r]:t(l,r,e[r])}function Gr(l,e){Object.keys(e).forEach(o=>{Ir(l,o,e[o])})}function Ir(l,e,o){const r=e.toLowerCase();r in l?l[r]=typeof l[r]=="boolean"&&o===""?!0:o:e in l?l[e]=typeof l[e]=="boolean"&&o===""?!0:o:t(l,e,o)}function Ne(l){return/-/.test(l)?Gr:Ur}function Wr(l){return Array.from(l.childNodes)}function ge(l,e){e=""+e,l.data!==e&&(l.data=e)}function xe(l,e,o,r){o==null?l.style.removeProperty(e):l.style.setProperty(e,o,r?"important":"")}function Wt(l,e){return new l(e)}let De;function je(l){De=l}function jr(){if(!De)throw new Error("Function called outside component initialization");return De}function Dr(l){jr().$$.on_mount.push(l)}const Se=[],Zt=[];let $e=[];const jt=[],Vr=Promise.resolve();let At=!1;function Tr(){At||(At=!0,Vr.then(ur))}function zt(l){$e.push(l)}const St=new Set;let Be=0;function ur(){if(Be!==0)return;const l=De;do{try{for(;Be<Se.length;){const e=Se[Be];Be++,je(e),Rr(e.$$)}}catch(e){throw Se.length=0,Be=0,e}for(je(null),Se.length=0,Be=0;Zt.length;)Zt.pop()();for(let e=0;e<$e.length;e+=1){const o=$e[e];St.has(o)||(St.add(o),o())}$e.length=0}while(Se.length);for(;jt.length;)jt.pop()();At=!1,St.clear(),je(l)}function Rr(l){if(l.fragment!==null){l.update(),ke(l.before_update);const e=l.dirty;l.dirty=[-1],l.fragment&&l.fragment.p(l.ctx,e),l.after_update.forEach(zt)}}function Hr(l){const e=[],o=[];$e.forEach(r=>l.indexOf(r)===-1?e.push(r):o.push(r)),o.forEach(r=>r()),$e=e}const xt=new Set;let ve;function ce(){ve={r:0,c:[],p:ve}}function fe(){ve.r||ke(ve.c),ve=ve.p}function w(l,e){l&&l.i&&(xt.delete(l),l.i(e))}function C(l,e,o,r){if(l&&l.o){if(xt.has(l))return;xt.add(l),ve.c.push(()=>{xt.delete(l),r&&(o&&l.d(1),r())}),l.o(e)}else r&&r()}function Dt(l){return l?.length!==void 0?l:Array.from(l)}function Ot(l,e){const o={},r={},a={$$scope:1};let n=l.length;for(;n--;){const s=l[n],f=e[n];if(f){for(const d in s)d in f||(r[d]=1);for(const d in f)a[d]||(o[d]=f[d],a[d]=1);l[n]=f}else for(const d in s)a[d]=1}for(const s in r)s in o||(o[s]=void 0);return o}function A(l){l&&l.c()}function N(l,e,o){const{fragment:r,after_update:a}=l.$$;r&&r.m(e,o),zt(()=>{const n=l.$$.on_mount.map(cr).filter(me);l.$$.on_destroy?l.$$.on_destroy.push(...n):ke(n),l.$$.on_mount=[]}),a.forEach(zt)}function Z(l,e){const o=l.$$;o.fragment!==null&&(Hr(o.after_update),ke(o.on_destroy),o.fragment&&o.fragment.d(e),o.on_destroy=o.fragment=null,o.ctx=[])}function Kr(l,e){l.$$.dirty[0]===-1&&(Se.push(l),Tr(),l.$$.dirty.fill(0)),l.$$.dirty[e/31|0]|=1<<e%31}function W(l,e,o,r,a,n,s=null,f=[-1]){const d=De;je(l);const p=l.$$={fragment:null,ctx:[],props:n,update:B,not_equal:a,bound:It(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(d?d.$$.context:[])),callbacks:It(),dirty:f,skip_bound:!1,root:e.target||d.$$.root};s&&s(p.root);let h=!1;if(p.ctx=o?o(l,e.props||{},(u,g,...m)=>{const b=m.length?m[0]:g;return p.ctx&&a(p.ctx[u],p.ctx[u]=b)&&(!p.skip_bound&&p.bound[u]&&p.bound[u](b),h&&Kr(l,u)),g}):[],p.update(),h=!0,ke(p.before_update),p.fragment=r?r(p.ctx):!1,e.target){if(e.hydrate){const u=Wr(e.target);p.fragment&&p.fragment.l(u),u.forEach(M)}else p.fragment&&p.fragment.c();e.intro&&w(l.$$.fragment),N(l,e.target,e.anchor),ur()}je(d)}class j{constructor(){Mt(this,"$$");Mt(this,"$$set")}$destroy(){Z(this,1),this.$destroy=B}$on(e,o){if(!me(o))return B;const r=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return r.push(o),()=>{const a=r.indexOf(o);a!==-1&&r.splice(a,1)}}$set(e){this.$$set&&!Er(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}const qr="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(qr);function $t(l){let e,o,r,a,n;const s=l[7].default,f=be(s,l,l[6],null);let d=[{href:l[0]},{class:o=`
  ...
  `},{rel:"noreferrer noopener"},{target:"_blank"},{role:"button"},{tabindex:"0"},{"aria-label":l[1]}],p={};for(let h=0;h<d.length;h+=1)p=Ft(p,d[h]);return{c(){e=x(l[3]),f&&f.c(),Ne(l[3])(e,p)},m(h,u){$(h,e,u),f&&f.m(e,null),r=!0,a||(n=[Ee(e,"click",function(){me(l[4])&&l[4].apply(this,arguments)}),Ee(e,"keyup",function(){me(l[5])&&l[5].apply(this,arguments)})],a=!0)},p(h,u){l=h,f&&f.p&&(!r||u&64)&&Ce(f,s,l,l[6],r?we(s,l[6],u,null):_e(l[6]),null),Ne(l[3])(e,p=Ot(d,[(!r||u&1)&&{href:l[0]},(!r||u&4&&o!==(o=`
    p-2 cursor-pointer text-primary rounded-full bg-surface-elevated-web
		focus:outline-none focus:ring-2 focus:ring-neutral-200 dark:focus:ring-neutral-700
		transition-colors ${l[2]}
