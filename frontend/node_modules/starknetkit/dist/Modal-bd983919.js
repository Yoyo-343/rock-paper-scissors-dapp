...
var yr = (l, e, o) => e in l ? vr(l, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : l[e] = o;
var Bt = (l, e, o) => (yr(l, typeof e != "symbol" ? e + "" : e, o), o);
import "./connector-d812307b.js";
import "starknet";
import "./trpc-94e013dd.js";
import { a as xr, e as Fr, i as Lr, b as Gt, g as Br } from "./index-1da7177c.js";
...
function W(l, e, o, r, a, n, s = null, f = [-1]) {
  ...
  if (p.ctx = o ? o(l, e.props || {}, (u, g, ...m) => {
    ...
    return p.ctx && a(p.ctx[u], p.ctx[u] = w) && (!p.skip_bound && p.bound[u] && p.bound[u](w), h && Pr(l, u)), g;
    ...
    e.intro && b(l.$$.fragment), N(l, e.target, e.anchor), ur();
  }
  We(d);
}
class j {
...
function l1(l) {
  ...
  return {
    ...
    p(g, [m]) {
      ...
      4 && b(p, 1)) : (p = Vt(g), p.c(), b(p, 1), p.m(e, o)) : p && (ce(), C(p, 1, 1, () => {
        p = null;
      }), fe()), (!d || m & /*subtitle*/
      2) && ge(
        n,
      ...
      8 && b(u, 1)) : (u = Tt(g), u.c(), b(u, 1), u.m(e, null)) : u && (ce(), C(u, 1, 1, () => {
        u = null;
      }), fe());
    },
    i(g) {
    ...
    p(f, [d]) {
      ...
      7) {
        ...
        for (p = 0; p < a.length; p += 1) {
          const h = Kt(f, a, p);
          n[p] ? (n[p].p(h, d), b(n[p], 1)) : (n[p] = Pt(h), n[p].c(), b(n[p], 1), n[p].m(o, null));
        }
...
class C1 extends j {
  constructor(e) {
    super(), W(this, e, b1, w1, U, { theme: 0, callback: 1, walletList: 2 });
  }
}
function _1(l) {
  let e, o;
...
class Ut extends j {
  constructor(e) {
    super(), W(this, e, k1, _1, U, { className: 0 });
  }
}
function v1(l) {
  let e;
...
function y1(l) {
  ...
  return o = new Ut({}), a = new Ot({
    ...
    i(s) {
      n || (b(o.$$.fragment, s), b(a.$$.fragment, s), n = !0);
    },
    o(s) {
...
function F1(l) {
  ...
  return {
    ...
    m(w, _) {
      $(w, e, _), i(e, o), i(o, r), g && g.m(r, null), i(o, a), i(o, n), i(n, s), i(n, f), i(n, d), i(e, p), m && m.m(e, null), h = !0;
    },
    p(w, [_]) {
      g && g.p && (!h || _ & /*$$scope*/
      8) && Ce(
      ...
      w[1] ? m ? (m.p(w, _), _ & /*showFallback*/
      2 && b(m, 1)) : (m = qt(w), m.c(), b(m, 1), m.m(e, null)) : m && (ce(), C(m, 1, 1, () => {
        m = null;
      }), fe());
    },
    i(w) {
...
function q1(l) {
  let e, o, r, a, n, s, f, d, p, h;
  return n = new mr({}), f = new wr({}), p = new gr({}), {
    c() {
    ...
    p: B,
    i(u) {
      h || (b(n.$$.fragment, u), b(f.$$.fragment, u), b(p.$$.fragment, u), h = !0);
    },
    o(u) {
...
function X1(l) {
  ...
  return o = new Ut({}), p = new Ot({
    ...
    i(u) {
      h || (b(o.$$.fragment, u), b(p.$$.fragment, u), h = !0);
    },
    o(u) {
...
function go(l) {
  ...
  return {
    ...
    p(g, [m]) {
      const w = {};
      m & /*handleCallback*/
      4 && (w.handleClick = /*handleCallback*/
      g[2]), m & /*handleCallback*/
      4 && (w.handleKeyup = /*func*/
      g[4]), m & /*$$scope, walletName*/
      33 && (w.$$scope = { dirty: m, ctx: g }), d.$set(w), /*showFallback*/
      g[1] ? u ? (u.p(g, m), m & /*showFallback*/
      2 && b(u, 1)) : (u = er(g), u.c(), b(u, 1), u.m(e, null)) : u && (ce(), C(u, 1, 1, () => {
        u = null;
      }), fe());
    },
    i(g) {
      h || (b(a.$$.fragment, g), b(d.$$.fragment, g), b(u), h = !0);
    },
    o(g) {
...
function vo(l) {
  ...
  return {
    ...
    m(H, J) {
      $(H, e, J), i(e, o), i(e, r), i(e, a), i(e, n), i(e, s), i(e, f), i(e, d), i(d, p), i(p, h), i(p, u), i(d, g), i(g, m), i(g, w), i(g, _), i(d, F), i(F, O), i(F, z), i(F, L), i(F, k), i(d, y), i(y, S), i(y, G), i(y, v), i(d, E), i(E, R), i(E, D), i(E, T), i(E, q), i(E, I), i(d, P), i(P, V), i(P, Y);
    },
    p(H, [J]) {
      J & /*size*/
      1 && t(
...
function Fo(l) {
  ...
  return {
    ...
    m(Le, kt) {
      $(Le, e, kt), i(e, o), i(e, r), i(e, a), i(e, n), i(e, s), i(e, f), i(e, d), i(e, p), i(e, h), i(e, u), i(e, g), i(e, m), i(e, w), i(w, _), i(_, F), i(_, O), i(_, z), i(_, L), i(_, k), i(_, y), i(_, S), i(_, G), i(w, v), i(v, E), i(v, R), i(v, D), i(v, T), i(v, q), i(v, I), i(v, P), i(v, V), i(v, Y), i(w, H), i(H, J), i(H, oe), i(H, ee), i(H, le), i(H, ae), i(w, te), i(te, Fe), i(te, De), i(te, Ve), i(te, Re), i(w, ue), i(ue, Te), i(ue, He), i(ue, Ke), i(ue, Pe), i(w, de), i(de, Ne), i(de, Ze), i(de, Ae), i(de, ze), i(w, ne), i(ne, Ft), i(ne, qe), i(ne, Xe), i(ne, Qe), i(ne, Ye), i(ne, Je), i(w, ie), i(ie, et), i(ie, tt), i(ie, rt), i(ie, ot), i(ie, lt), i(w, re), i(re, Lt), i(re, at), i(re, nt), i(re, it), i(re, st), i(re, ct), i(re, ft), i(re, ut), i(w, se), i(se, dt), i(se, pt), i(se, ht), i(se, gt), i(se, mt), i(w, pe), i(pe, wt), i(pe, bt), i(pe, Ct), i(pe, _t), i(w, he), i(he, Oe), i(he, Ue), i(he, Ge), i(he, Ie);
    },
    p(Le, [kt]) {
      kt & /*size*/
      1 && t(
...
function Go(l) {
  let e, o, r, a, n, s, f, d, p, h, u, g, m, w, _;
  const F = (
    /*#slots*/
    l[4].icons
  ), O = we(
  ...
  return {
    c() {
      e = x("div"), o = x("div"), r = x("div"), a = x("h4"), n = X(
        ...
        /*subtitle*/
        l[1]
      ), p = K(), h = x("div"), O && O.c(), u = K(), A(g.$$.fragment), m = K(), w = x("div"), L && L.c(), t(a, "class", "text-heading5 text-primary capitalize"), t(f, "class", "text-l1 text-secondary-web"), t(r, "class", "flex flex-col gap-1 text-left"), t(h, "class", "flex gap-3 text-primary"), t(o, "class", "flex flex-col gap-3"), t(w, "class", "flex items-center"), t(e, "class", "flex flex-row gap-3 px-4 py-3 rounded-xl bg-surface-elevated");
    },
    m(k, y) {
      $(k, e, y), i(e, o), i(o, r), i(r, a), i(a, n), i(r, s), i(r, f), i(f, d), i(o, p), i(o, h), O && O.m(h, null), i(o, u), N(g, o, null), i(e, m), i(e, w), L && L.m(w, null), _ = !0;
    },
    p(k, [y]) {
      (!_ || y & /*title*/
      1) && ge(
      ...
      k[5]), y & /*$$scope*/
      64 && (S.$$scope = { dirty: y, ctx: k }), g.$set(S), L && L.p && (!_ || y & /*$$scope*/
      64) && Ce(
        L,
        z,
        k,
    ...
    i(k) {
      _ || (b(O, k), b(g.$$.fragment, k), b(L, k), _ = !0);
    },
    o(k) {
      C(O, k), C(g.$$.fragment, k), C(L, k), _ = !1;
    },
    d(k) {
...
function Wo(l) {
  ...
  return e = new wr({}), r = new gr({}), {
    ...
    i(n) {
      a || (b(e.$$.fragment, n), b(r.$$.fragment, n), a = !0);
    },
    o(n) {
  ...
  return f && (o = Wt(f, d())), {
    ...
    p(p, h) {
      ...
      p[4][
        ...
        f ? (o = Wt(f, d()), A(o.$$.fragment), b(o.$$.fragment, 1), N(o, e, r)) : o = null;
      }
      (!s || h & /*store*/
      4) && a !== (a = /*storeData*/
      p[4][
  ...
  return e = f(l), o = s[e] = n[e](l), {
    ...
    p(d, p) {
      ...
      e = f(d), e !== h && (ce(), C(s[h], 1, 1, () => {
        s[h] = null;
      }), fe(), o = s[e], o || (o = s[e] = n[e](d), o.c()), b(o, 1), o.m(r.parentNode, r));
    },
    i(d) {
      a || (b(o), a = !0);
    },
...
function nr(l) {
  ...
  return e = new Ut({}), n = new Cr({
    ...
    i(f) {
      s || (b(e.$$.fragment, f), b(n.$$.fragment, f), s = !0);
    },
    o(f) {
...
function Po(l) {
  ...
  return {
    ...
    p(h, [u]) {
      /*isArgent*/
      h[0] ? f ? u & /*isArgent*/
      1 && b(f, 1) : (f = lr(h), f.c(), b(f, 1), f.m(o, r)) : f && (ce(), C(f, 1, 1, () => {
        f = null;
      }), fe()), /*store*/
      h[2] && /*storeLink*/
      h[3] ? d ? (d.p(h, u), u & /*store, storeLink*/
      12 && b(d, 1)) : (d = ar(h), d.c(), b(d, 1), d.m(o, null)) : d && (ce(), C(d, 1, 1, () => {
        d = null;
      }), fe()), /*isArgent*/
      h[0] ? p ? u & /*isArgent*/
      1 && b(p, 1) : (p = nr(h), p.c(), b(p, 1), p.m(n, null)) : p && (ce(), C(p, 1, 1, () => {
        p = null;
      }), fe());
    },
    i(h) {
...
function ir(l) {
  ...
  return ~(n = g(l)) && (s = u[n] = h[n](l)), {
    ...
    m(m, w) {
      $(m, e, w), i(e, o), N(r, o, null), i(o, a), ~n && u[n].m(o, null), l[20](e), p = !0;
    },
    p(m, w) {
      const _ = {};
      w & /*nodeRef*/
      128 && (_.handleClose = /*func_1*/
      m[15]), w & /*dappName*/
      4 && (_.title = /*dappName*/
      m[2]), w & /*showBackButton, layout*/
      33 && (_.showBackButton = /*showBackButton*/
      m[5] && ![Q.walletList, Q.success].includes(
        /*layout*/
        m[0]
      )), r.$set(_);
      let F = n;
      n = g(m), n === F ? ~n && u[n].p(m, w) : (s && (ce(), C(u[F], 1, 1, () => {
        u[F] = null;
      }), fe()), ~n ? (s = u[n], s ? s.p(m, w) : (s = u[n] = h[n](m), s.c()), b(s, 1), s.m(o, null)) : s = null), (!p || w & /*layout*/
      1 && f !== (f = `
        rounded-3xl bg-surface-default shadow-modal dark:shadow-none flex flex-col
        z-[9999] w-full max-w-[380px] mx-6 p-6 text-center gap-8
        ${/*layout*/
      m[0] !== Q.walletList ? "min-h-[570px]" : ""}
      `)) && t(o, "class", f), (!p || w & /*darkModeControlClass*/
...
function il(l) {
  ...
  return {
    ...
    p(a, n) {
      ...
      512 && b(r, 1)) : (r = sr(a), r.c(), b(r, 1), r.m(e.parentNode, e)) : r && (ce(), C(r, 1, 1, () => {
        r = null;
      }), fe());
    },
    i(a) {
...
function sl(l) {
  ...
  return {
    ...
    p(a, [n]) {
      ...
      9 && b(r, 1)) : (r = ir(a), r.c(), b(r, 1), r.m(e.parentNode, e)) : r && (ce(), C(r, 1, 1, () => {
        r = null;
      }), fe());
    },
    i(a) {
...
function cl(l, e, o) {
  ...
  } } = e, w = xr(), { theme: _ = "dark" } = e, { darkModeControlClass: F = _ === "dark" ? "dark" : "" } = e;
  Vr(async () => {
    if (_ === "dark" || _ == null && window.matchMedia("(prefers-color-scheme: dark)").matches ? o(1, F = "dark") : o(1, F = "light"), w) {
      try {
        setTimeout(() => {
          m(Gt(new Mr()));
        });
  ...
  return l.$$set = (v) => {
    "dappName" in v && o(2, s = v.dappName), "layout" in v && o(0, f = v.layout), "modalWallets" in v && o(3, h = v.modalWallets), "selectedWallet" in v && o(4, u = v.selectedWallet), "showBackButton" in v && o(5, g = v.showBackButton), "callback" in v && o(6, m = v.callback), "theme" in v && o(13, _ = v.theme), "darkModeControlClass" in v && o(1, F = v.darkModeControlClass);
  }, l.$$.update = () => {
