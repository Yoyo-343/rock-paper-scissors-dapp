...
import { Flex as p, forwardRef as x, Center as f, Circle as a } from "@chakra-ui/react";
import { NavLink as m } from "react-router-dom";
const h = 16;
function C(o) {
  return /* @__PURE__ */ r(p, { top: "initial", bottom: 0, height: h, backgroundColor: "surface-default", borderTop: "1px solid", borderTopColor: "border", boxShadow: "menu", ...o });
}
function v(o) {
...
const k = x(({ icon: o, label: e, badgeLabel: n, badgeDescription: i, as: l = m, ...c }, b) => {
  const s = Number(n) > 0;
